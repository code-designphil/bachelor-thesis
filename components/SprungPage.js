export default class SprungPage extends HTMLElement {
  constructor() {
    super();

    this.root = this.attachShadow({ mode: "open" });

    const template = document.getElementById("sprung-page-template");
...
customElements.define("sprung-page", SprungPage);
