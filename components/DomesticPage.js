export default class DomesticPage extends HTMLElement {
  constructor() {
    super();

    this.root = this.attachShadow({ mode: "open" });

    const template = document.getElementById("domestic-page-template");
    ...
    async function loadCSS() {
      const pageStyles = await fetch("/components/DomesticPage.css");
...
customElements.define("domestic-page", DomesticPage);
