export default class MenschheitPage extends HTMLElement {
    constructor() {
        super();

        this.root = this.attachShadow({mode: "open"});

        const template = document.getElementById("menschheit-page-template");
...
customElements.define("menschheit-page", MenschheitPage);
